            ...
            <el-table-column
                ...
                <template slot-scope="scope">
                    <div class="buttons">
                        ...
                        <el-button @click="handleEdit(scope.row.username)" size="small" type="primary">Edytuj</el-button>
                    </div>
                </template>
            </el-table-column>
        </el-table>
    ...
    export default {
        ...
        methods: {
            ...
            handleConfirmDelete() {
                ...
                this.$axios.delete("http://localhost:8081/admin/employees/"+this.toDeleteUsername)
                    .then(resp => {
                        console.log(resp);
                        this.$message({
                    ...
                    .catch(error => {
                        console.log(error);
                        this.$message({
                            message: 'Błąd przy usuwaniu pracownika.',
                            type: 'error'
                        });
                    });
            },
            handleEdit(username) {
                ...
                this.$router.push("/admin/employees/" + username);
            },
            loadEmployees: function () {
                this.loading = true;

                this.$axios.get("http://localhost:8081/admin/employees/", {})
                    .then(resp => {
